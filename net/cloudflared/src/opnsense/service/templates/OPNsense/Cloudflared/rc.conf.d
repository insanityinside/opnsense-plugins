...
{% endif %}
{% if not helpers.empty('OPNsense.Cloudflared.general.icmpv4_src') %}
{% set ns.env = ns.env + ' TUNNEL_ICMPV4_SRC=' + OPNsense.Cloudflared.general.icmpv4_src|trim %}
{% endif %}
{% if not helpers.empty('OPNsense.Cloudflared.general.icmpv6_src') %}
{% set ns.env = ns.env + ' TUNNEL_ICMPV6_SRC=' + OPNsense.Cloudflared.general.icmpv6_src|trim %}
{% endif %}
